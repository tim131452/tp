  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('user.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['User Name', 'Role Name'],
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('user.destroy', ['id' => $user->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('user.edit', ['id' => $user->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
