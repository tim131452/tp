                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('client.update', ['id' => $client->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('client_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="client_name" type="text" class="form-control" name="client_name" value="{{ $client->client_name }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('client_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="client_code" type="text" class="form-control" name="client_code" value="{{ $client->client_code }}" required>
                        ...
                        <div class="form-group{{ $errors->has('client_desc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="client_desc" type="text" class="form-control" name="client_desc" value="{{ $client->client_desc }}" required>
