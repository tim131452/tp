  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('employee-management.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['First Name', 'Users_Email'],
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($employees as $employee)
                <tr role="row" class="odd">
                  ...
                  <td class="hidden-xs">{{ $employee->users_email}}</td>
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('employee-management.destroy', ['id' => $employee->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('employee-management.edit', ['id' => $employee->id]) }}" class="btn btn-warning col-sm-3 col-xs-5">
                        Update
                        </a>
