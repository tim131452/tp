        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('user.update', ['id' => $user->id])); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control js-role" name="role_id">
                                    ...
                                    <option <?php echo e($user->role_id == $role->id ? 'selected' : ''); ?> value="<?php echo e($role->id); ?>"><?php echo e($role->name); ?></option>
