<?php $__env->startSection('action-content'); ?>
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="<?php echo e(route('city.create')); ?>">Add new city</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="<?php echo e(route('city.destroy', ['id' => $city->id])); ?>" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_method" value="DELETE">
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        <a href="<?php echo e(route('city.edit', ['id' => $city->id])); ?>" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1 to <?php echo e(count($cities)); ?> of <?php echo e(count($cities)); ?> entries</div>
        </div>
        <div class="col-sm-7">
...
<?php echo $__env->make('system-mgmt.city.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>