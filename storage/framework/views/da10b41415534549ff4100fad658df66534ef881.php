<?php $__env->startSection('action-content'); ?>
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="<?php echo e(route('employee.create')); ?>">Add new employee</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="<?php echo e(route('employee.search')); ?>">
         <?php echo e(csrf_field()); ?>

         <?php $__env->startComponent('layouts.search', ['title' => 'Search']); ?>
          <?php $__env->startComponent('layouts.two-cols-search-row', ['items' => ['First Name', 'Department'],
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1"><?php echo e($employee->firstname); ?> <?php echo e($employee->middlename); ?> <?php echo e($employee->lastname); ?></td>
                  ...
                  <td>
                    <form class="row" method="POST" action="<?php echo e(route('employee.destroy', ['id' => $employee->id])); ?>" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_method" value="DELETE">
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        <a href="<?php echo e(route('employee.edit', ['id' => $employee->id])); ?>" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
