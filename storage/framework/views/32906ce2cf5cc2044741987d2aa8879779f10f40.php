          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                  ...
                  <?php else: ?>
                 <div class="pull-left">
                    <a class="btn btn-default btn-flat" href="<?php echo e(route('password.request')); ?>">Change Password</a>
                 </div>
                  <div class="pull-left">
                      <a class="btn btn-default btn-flat" href="<?php echo e(url('profile')); ?>">Profile</a>
                  </div>
                 <div class="pull-right">
                    <a class="btn btn-default btn-flat" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout').submit();">
                    Logout
                    </a>
                 </div>
                  <?php endif; ?>
