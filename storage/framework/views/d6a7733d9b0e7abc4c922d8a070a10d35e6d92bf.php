    ...
    <div class="box">
        <div class="box-header">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a class="btn btn-primary" href="<?php echo e(route('client.create')); ?>">Add new client</a>
                </div>
            </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <form method="POST" action="<?php echo e(route('client.search')); ?>">
                <?php echo e(csrf_field()); ?>

                <?php $__env->startComponent('layouts.search', ['title' => 'Search']); ?>
                <?php $__env->startComponent('layouts.two-cols-search-row', ['items' => ['Client_Code', 'Client_Name'],
                    ...
                    <div class="col-sm-12">
                        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><?php echo e($client->client_desc); ?></td>
                                <td>
                                    <form class="row" method="POST" action="<?php echo e(route('client.destroy', ['id' => $client->id])); ?>" onsubmit = "return confirm('Are you sure?')">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                        <a href="<?php echo e(route('client.edit', ['id' => $client->id])); ?>" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                                            Update
                                        </a>
